...
constexpr uint32_t SPIM00_BASE = static_cast<uint32_t>(NRF_SPIM00_BASE);
constexpr uint32_t UARTE00_BASE = static_cast<uint32_t>(NRF_UARTE00_BASE);
...
constexpr uint32_t TWIS20_BASE = static_cast<uint32_t>(NRF_TWIS20_BASE);
...
constexpr uint32_t TWIS21_BASE = static_cast<uint32_t>(NRF_TWIS21_BASE);
...
constexpr uint32_t SPIM22_BASE = static_cast<uint32_t>(NRF_SPIM22_BASE);
constexpr uint32_t SPIS22_BASE = static_cast<uint32_t>(NRF_SPIS22_BASE);
constexpr uint32_t TWIM22_BASE = static_cast<uint32_t>(NRF_TWIM22_BASE);
constexpr uint32_t TWIS22_BASE = static_cast<uint32_t>(NRF_TWIS22_BASE);
constexpr uint32_t UARTE22_BASE = static_cast<uint32_t>(NRF_UARTE22_BASE);
constexpr uint32_t SPIM30_BASE = static_cast<uint32_t>(NRF_SPIM30_BASE);
constexpr uint32_t SPIS30_BASE = static_cast<uint32_t>(NRF_SPIS30_BASE);
constexpr uint32_t TWIM30_BASE = static_cast<uint32_t>(NRF_TWIM30_BASE);
constexpr uint32_t TWIS30_BASE = static_cast<uint32_t>(NRF_TWIS30_BASE);
constexpr uint32_t UARTE30_BASE = static_cast<uint32_t>(NRF_UARTE30_BASE);
...
constexpr uint32_t PWM21_BASE = static_cast<uint32_t>(NRF_PWM21_BASE);
constexpr uint32_t PWM22_BASE = static_cast<uint32_t>(NRF_PWM22_BASE);
...
constexpr uint32_t NFCT_BASE = static_cast<uint32_t>(NRF_NFCT_BASE);
...
constexpr uint32_t TIMER21_BASE = 0x400CB000UL;
constexpr uint32_t TIMER22_BASE = 0x400CC000UL;
constexpr uint32_t TIMER23_BASE = 0x400CD000UL;
constexpr uint32_t TIMER24_BASE = 0x400CE000UL;
constexpr uint32_t TIMER10_BASE = 0x40085000UL;
constexpr uint32_t TIMER00_BASE = 0x40055000UL;
...
constexpr uint32_t TIMER21_BASE = 0x500CB000UL;
constexpr uint32_t TIMER22_BASE = 0x500CC000UL;
constexpr uint32_t TIMER23_BASE = 0x500CD000UL;
constexpr uint32_t TIMER24_BASE = 0x500CE000UL;
constexpr uint32_t TIMER10_BASE = 0x50085000UL;
constexpr uint32_t TIMER00_BASE = 0x50055000UL;
