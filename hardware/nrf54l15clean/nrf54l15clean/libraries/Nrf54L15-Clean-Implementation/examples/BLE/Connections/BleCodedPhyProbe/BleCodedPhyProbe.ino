 ...
 * BleCodedPhyProbe
 *
 * Peripheral-side coded PHY transition probe. It brings the link up on coded
 * PHY, keeps 244-byte notifications flowing, waits for the central to request
 * a fallback to 1M, then requests coded again and verifies that long traffic
 * still survives the return transition.
 */
