 ...
 * Ble2MPhyCentral
 *
 * Central-side BLE 2M PHY example for the XIAO nRF54L15 pair.
 *
 * Use it with Ble2MPhyPeripheral on the other board. The sketch discovers and
 * subscribes to the peripheral notify characteristic, prints getPHY() in the
 * status log, requests 2M with requestPHY(kBlePhy2M), then verifies long
 * traffic across a forced 1M fallback and the later return to 2M.
 */
