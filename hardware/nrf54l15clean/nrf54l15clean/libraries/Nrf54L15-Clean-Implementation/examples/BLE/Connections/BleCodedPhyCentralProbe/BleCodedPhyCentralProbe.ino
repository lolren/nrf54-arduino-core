/*
 * BleCodedPhyCentralProbe
 *
 * Central-side coded PHY transition probe. It subscribes to the peripheral's
 * 244-byte notifications, requests a fallback to 1M after coded traffic is
 * proven, then waits for the peripheral to return the link to coded and
 * confirms long traffic again after the recovery.
 */
