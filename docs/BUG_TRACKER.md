...
- [x] GAP-BLE-GATT-RT-01: Optional runtime custom GATT registration baseline implemented.
  ...
  - Demo sketch: `examples/BLE/GATT/BleCustomGattRuntime/BleCustomGattRuntime.ino`.
...
- [ ] GAP-BLE-CS-01: Full Bluetooth Channel Sounding LL capability (document exact hardware/runtime constraints and host control model).
  - Partial progress: phase-based two-board channel sounding baseline now available via
    `examples/BLE/ChannelSounding/BleChannelSoundingReflector/BleChannelSoundingReflector.ino` and
...
- [x] LL control response scheduling widened:
  ...
  - Files:
    ...
    - `hardware/nrf54l15clean/nrf54l15clean/libraries/Nrf54L15-Clean-Implementation/examples/BLE/Security/BlePairingEncryptionStatus/BlePairingEncryptionStatus.ino`
...
- [x] Runtime custom GATT feature-breadth step:
  ...
  - new example: `hardware/nrf54l15clean/nrf54l15clean/libraries/Nrf54L15-Clean-Implementation/examples/BLE/GATT/BleCustomGattRuntime/BleCustomGattRuntime.ino`
  - validation captures:
