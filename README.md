...
- built-in generic VPR service currently reporting `svc=1.11` /
  `opmask=0xFFFFF`
- validated VPR offload/service probes:
  ...
  `VprBleConnectionCsBindProbe`, `VprBleConnectionCsHandoffProbe`,
